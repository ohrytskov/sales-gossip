      ...
      >
        ...
        <div data-svg-wrapper data-layer="Frame" className="Frame left-[516.40px] top-[26.40px] absolute cursor-pointer" onClick={onClose} role="button" aria-label="Close">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_407_13115)">
        ...
        <div data-layer="Frame 48097136" className="Frame48097136 w-[518px] h-36 left-[24px] top-[128px] absolute bg-[#fff5f5] overflow-hidden relative">
          {/* preview area */}
          {preview ? (
            // show chosen banner (object-fit cover)
            <img src={preview} alt="Banner preview" className="w-full h-full object-cover" />
          ) : (
            <div className="w-full h-full bg-[#fff5f5]" />
          )}

          {/* dark circle overlay (visual) */}
          <div data-svg-wrapper data-layer="Ellipse 13" className="Ellipse13 left-[235px] top-[45px] absolute pointer-events-none">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="24" cy="24" r="24" fill="#10112A" fillOpacity="0.5"/>
            </svg>
          </div>

          {/* camera icon */}
          <div data-svg-wrapper data-layer="Frame" className="Frame left-[247px] top-[57px] absolute pointer-events-none">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_407_13184)">
          ...
          <button type="button" onClick={() => fileInputRef.current?.click()} className="absolute inset-0 z-20" aria-label="Change banner">
