...
export default function CompanyDetail({ companyName }: any) {
    ...
    return (
      <div className="bg-white">
        ...
        <main className="mx-auto flex w-full max-w-[1440px] flex-col items-center px-[142px] pb-24 pt-[50px]">
          <PageState
            loading
            title="Loading company posts"
            description="Fetching the latest posts for this company."
          />
        </main>
      </div>
    )
  ...
  if (error) {
    return (
      <div className="bg-white">
        ...
        <main className="mx-auto flex w-full max-w-[1440px] flex-col items-center px-[142px] pb-24 pt-[50px]">
          <PageState
            title="Could not load company posts"
  ...
  const filteredPosts = posts.filter(post => {
    const companyValue = (post?.companyName || post?.company || '').toLowerCase()
    return companyValue === normalizedCompany
  })
