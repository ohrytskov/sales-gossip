...
export default function Companies() {
  ...
  return (
    <div className="relative">
      ...
      <div className="mt-[0px] mx-[142px] flex flex-wrap gap-6 overflow-y-auto">
