          ...
          <div data-layer="Modal" className={`Modal w-[566px] ${emailEditStep === 'check' ? 'h-80' : 'h-96'} relative bg-white rounded-3xl overflow-hidden`} onClick={e => e.stopPropagation()}>
            {emailEditStep === 'form' ? (
              ...
              <>
                ...
                <div data-layer="CorporateGossip sent a confirmation email to john12@gmail.com. Click the verify link in the email to secure your CorporateGossip account." className="CorporateGossipSentAConfirmationEmailToJohn12GmailComClickTheVerifyLinkInTheEmailToSecureYourCorporateGossipAccount w-96 left-[24px] top-[140px] absolute justify-start"><span className="text-[#454662] text-base font-normal font-['Inter'] leading-normal">CorporateGossip sent a confirmation email to </span><span className="text-[#10112a] text-base font-semibold font-['Inter'] leading-normal">{newEmail}</span><span className="text-[#454662] text-base font-normal font-['Inter'] leading-normal">. Click the verify link in the email to secure your CorporateGossip account.</span></div>
      ...
      {showDeleteAccount && (
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50" onClick={() => ( setShowDeleteAccount(false), setDeletePassword(''), setDeleteReason('') )}>
          <div data-layer="Modal" className="Modal w-[566px] h-[516px] relative bg-white rounded-3xl overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <div data-layer="OnceYouDeleteYourAccount..." className="OnceYouDeleteYourAccountYourProfileAndUsernameWillBePermanentlyRemovedFromCorporateGossipYourPostsCommentsAndMessagesWillNoLongerBeLinkedToYourAccountButTheyWonTBeDeletedUnlessYouRemoveThemYourselfBeforehand w-[465px] left-[24px] top-[96px] absolute justify-start text-[#454662] text-sm font-normal font-['Inter'] leading-snug">Once you delete your account, your profile and username will be permanently removed from CorporateGossip. Your posts, comments, and messages will no longer be linked to your account, but they won&apos;t be deleted unless you remove them yourself beforehand.</div>
